...
const doctorsData = [
  new Doctor(1, "Иванова Мария Давидовна", 3, "Мужской", "Высшая", "Кандидат медицинских наук", 4.8, 56, "Клиника", "../images/ivanov.jpg"),
  new Doctor(2, "Чатинян Гарик Артурович", 15, "Женский", "Вторая", "Доктор медицинских наук", 5, 24, "Онлайн", "../images/ivanov.jpg"),
